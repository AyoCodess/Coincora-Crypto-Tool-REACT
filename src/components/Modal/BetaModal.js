      ...
      <Dialog
        ...
        <div className='flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
          ...
          <Transition.Child
            ...
            <div className='relative inline-block align-middle bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:ml-60 sm:my-8 sm:align-middle sm:max-w-sm md:max-w-lg sm:w-full sm:p-6'>
