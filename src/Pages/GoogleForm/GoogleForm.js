...
function GoogleForm() {
  const component = (
    <div className='flex flex-col justify-center items-center min-h-[65vh]'>
      <p className='w-full text-center text-3xl mb-10 text-gray-400 hover:text-gray-500 transition ease-in-out duration-700'>
  ...
  return <PageBackground component={component} />;
}
